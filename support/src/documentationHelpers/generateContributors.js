#!/usr/bin/env node
/**
 * Generate contributors.md markdown based on github users who have commits in the repo.
 * It outputs to the command line, which then can be copied and pasted into contributing/contributors.md.
 *
